  ...
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      <Path
        ...
        fill={getIconColor(color, 0, '#47B7F8')}
      />
      <Path
        ...
        fill={getIconColor(color, 1, '#F7E42F')}
      />
      <Path
      ...
      />
      <Path
        d="M721.7 193m-11.5 0a11.5 11.5 0 1 0 23 0 11.5 11.5 0 1 0-23 0Z"
        fill={getIconColor(color, 3, '#F8B62D')}
      />
      <Path
        d="M206.8 253.7m-15.4 0a15.4 15.4 0 1 0 30.8 0 15.4 15.4 0 1 0-30.8 0Z"
        fill={getIconColor(color, 4, '#F8B62D')}
      />
      <Path
        d="M812.9 362.9m-15.4 0a15.4 15.4 0 1 0 30.8 0 15.4 15.4 0 1 0-30.8 0Z"
        fill={getIconColor(color, 5, '#F7E42F')}
      />
      <Path
        ...
        fill={getIconColor(color, 6, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 7, '#FAEE00')}
      />
      <Path
        ...
        fill={getIconColor(color, 8, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 9, '#FCEE21')}
      />
      <Path
        d="M446.8 272.4c0-33.6 27.3-60.9 60.9-60.9s60.9 27.3 60.9 60.9"
        fill={getIconColor(color, 10, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 11, '#3E3A39')}
      />
      <Path
        d="M593.8 848.3c0 47.6-38.6 86.2-86.2 86.2s-86.2-38.6-86.2-86.2"
        fill={getIconColor(color, 12, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 13, '#3E3A39')}
      />
      <Path
        ...
        fill={getIconColor(color, 14, '#3E3A39')}
      />
      <Path
        ...
        fill={getIconColor(color, 15, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 16, '#3E3A39')}
      />
      <Path
        ...
        fill={getIconColor(color, 17, '#3E3A39')}
      />
      <Path
